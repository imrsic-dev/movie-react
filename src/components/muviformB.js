...
export default function MovieForm(props) {
    ...
    const { register, preHandleSubmit, watch, validateErrors } = useForm();

    const [showCancel, setShowCancel] = useState(props.editMovie)
                ...
                <form>
                    ...
                    <div>
                        <button
                            ...
                            onClick={(e)=>preHandleSubmit(props.handleSubmit(e, id,{name, genre, rating, explicit}, resetForm))}
                        >
                            Save
                        </button>
